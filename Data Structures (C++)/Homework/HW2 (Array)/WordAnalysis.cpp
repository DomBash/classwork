...
struct words{  //Create a struct for the words and how many of each word to be put in struct array
	string word;
	int count;
	
};

bool wordscompare(words lhs, words rhs) {return lhs.count > rhs.count;} //Creat bool to sort array
